...
const app = {
  ...
  // La URL viene directamente de Firebase Storage, así que el navegador puede cargarla
  // igual que cualquier otro recurso HTTPS, sin pasos intermedios de descarga/decodificación.
  async previewDocument(url, name, type) {
    ...
    if (resolvedType.startsWith('image/')) {
      ...
      if (isIOS) {
        ...
        content.innerHTML = `<iframe src="${url}" style="width:100%; height:100%; border:none; border-radius:6px; background:#040811;"></iframe>`;
      }
    } else {
      content.innerHTML = `
