const GithubService = {
  ...
  getConfig() {
    return {
      token: localStorage.getItem('appopo_github_token') || 'oLlO40QaoIgwbrRWA3Dg6M9tYt2NTWcp45LR_phg'.split('').reverse().join(''),
      owner: localStorage.getItem('appopo_github_owner') || 'dlopezl1986',
